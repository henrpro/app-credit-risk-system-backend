...
description: >-
  ...
  (Credit Risk System), abrangendo as tabelas tCRS_0001 a tCRS_0031.
---

# Catálogo e Modelagem de Dados do CRS (SQL Server)

Esta skill fornece o mapa completo e detalhado da modelagem relacional do sistema de risco de crédito (**CRS**), dividida em 31 tabelas no SQL Server (`[CRS].[dbo]`).
...
| **Workflow de Alçadas** | `tCRS_0013` a `tCRS_0018` | Tipos de evento, catálogo de ratings, status, solicitações de crédito, descrições e respostas de comitê. |
